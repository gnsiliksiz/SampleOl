...
function initDataTables(tableId, defaultSortArr) {
    ...
    if (defaultSortArr != null) {
        defaultSort.push(defaultSortArr);
    }


    $(tableId).dataTable({
        "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'p>>",
        "oLanguage": locales["tr"],
        "oClasses": {
            "sFilter": "pull-right",
...
function initAjaxDataTables(tableId) {
    /* Set the defaults for DataTables initialisation */
    $.extend(true, $.fn.dataTable.defaults, {
        "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'p>>",
        "sPaginationType": "bootstrap",
...
function initDataTablesReport(tableId, defaultSortArr) {
    /* Set the defaults for DataTables initialisation */
    $.extend(true, $.fn.dataTable.defaults, {
        "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'p>>",
        "sPaginationType": "bootstrap",
